...
export default class TwitchAnnounce extends Lavenza.Command {
  ...
  static async execute(resonance) {
    ...
    if ('a' in resonance.order.args) {
      await this.talent.ttvannAddStream(resonance.message.guild.id, resonance.order.args.a, resonance.bot).catch(Lavenza.stop);
    ...
    if ("r" in resonance.order.args) {
      await this.talent.ttvannRemoveStream(resonance.message.guild.id, resonance.order.args.r, resonance.bot).catch(Lavenza.stop);
    ...
    if ("c" in resonance.order.args) {
      ...
      await this.talent.ttvannSetAnnChannel(resonance.message.guild.id, resonance.order.args.c, resonance.bot).catch(Lavenza.stop);
