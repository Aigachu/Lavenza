...
class Pong extends Command_1.default {
    ...
    execute(resonance) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // You set the required parameters, which SHOULD be straightforward. The third parameter is the time limit set for
            ...
            /** @see ./handlers */
            yield this.fireClientHandlers(resonance, { goodDay: goodDay }, 'myCustomMethod');
        });
    }
}
