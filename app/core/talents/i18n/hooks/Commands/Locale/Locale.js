...
export default class Hello extends Lavenza.Command {
  ...
  static async execute(resonance) {
    ...
    if (resonance.order.args._[0] === 'set') {
      ...
      // Send a reply.
      await resonance.reply("I've modified your locale settings! From now on, I will answer you in this language when I can. You can change this setting at any time.");
    }
