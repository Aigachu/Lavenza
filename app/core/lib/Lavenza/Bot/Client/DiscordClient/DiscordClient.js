...
const DiscordJSClient = DiscordJS.Client;
const Embed = DiscordJS.RichEmbed;
const Attachment = DiscordJS.Attachment;
 ...
 */
module.exports = class DiscordClient extends DiscordJSClient {
