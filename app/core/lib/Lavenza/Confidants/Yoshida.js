...
if (process.env.GOOGLE_TRANSLATE_PROJECT_ID) {
  ...
  googleTranslate = new GoogleTranslate.Translate({
    projectId: googleTranslateProjectId,
  });
}

// Imports.
const Akechi = require('./Akechi');
const Igor = require('./Igor');
...
module.exports = class Yoshida {
   ...
   * @returns {Promise<string>}
   */
  static async personalize(defaultText, tag, bot) {
