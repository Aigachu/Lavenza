...
module.exports = class Morgana {
   ...
   */
  static async log(message, replacers = undefined, type = 'default', locale = process.env.DEFAULT_LOCALE) {
   ...
   * @inheritDoc
   */
  static async success(message, replacers = undefined) {
   ...
   * @inheritDoc
   */
  static async status(message, replacers = undefined) {
   ...
   * @inheritDoc
   */
  static async warn(message, replacers = undefined) {
   ...
   * @inheritDoc
   */
  static async error(message, replacers = undefined) {
