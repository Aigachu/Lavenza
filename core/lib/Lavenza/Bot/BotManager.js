...
class BotManager {
    ...
    static gestalt() {
        return __awaiter(this, void 0, void 0, function* () {
            // Some flavor.
            yield Morgana_1.default.status("Running Gestalt bootstrap process for the Bot Manager...");
            ...
            // Some flavor.
            yield Morgana_1.default.status("Gestalt bootstrap process complete for the Bot Manager!");
        });
    }
    /**
    ...
    static bootAutoBoots() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (Sojiro_1.default.isEmpty(Core_1.default.settings.autoboot)) {
                yield Morgana_1.default.warn(`No bots set up for autobooting. Continuing!`);
                return;
            }
    ...
    static registerBot(botId, directory = undefined) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (Sojiro_1.default.isEmpty(config)) {
                yield Morgana_1.default.warn('Configuration file could not be loaded for following bot: {{bot}}', { bot: botId });
                return;
            }
            ...
            if (config.active !== undefined && config.active === false) {
                yield Morgana_1.default.warn('The {{bot}} bot has been set to inactive. It will not be registered.', { bot: botId });
                return;
            }
            // Instantiate and set the bot to the collection.
            let bot = new Bot_1.default(botId, config);
    ...
    static registerAllBotsInDirectory() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let botDirectories = yield Akechi_1.default.getDirectoriesFrom(Core_1.default.paths.bots);
            // If for some reason, bot directories could not be loaded, we stop the app.
            if (botDirectories === undefined) {
                yield Igor_1.default.throw("Other than the 'example' folder, no bot folders seem to exist in /app/bots. The whole point of this app is to run bots, so create one!");
            }
