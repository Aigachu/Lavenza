...
class DiscordResonance extends Resonance_1.Resonance {
    ...
    getLocale() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const i18nUserConfig = yield Gestalt_1.Gestalt.get(`/i18n/${this.bot.id}/clients/discord/users`)
            ...
            const i18nChannelConfig = yield Gestalt_1.Gestalt.get(`/i18n/${this.bot.id}/clients/discord/channels`)
                .catch(Igor_1.Igor.stop);
            // Now, we check if the user has a configured locale. If that's the case, we return with this locale.
            ...
            const i18nGuildConfig = yield Gestalt_1.Gestalt.get(`/i18n/${this.bot.id}/clients/discord/guilds`)
                .catch(Igor_1.Igor.stop);
            // Now, we check if the user has a configured locale. If that's the case, we return with this locale.
