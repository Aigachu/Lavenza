...
const PromptExceptionType_1 = require("../../../../../../../core/lib/Lavenza/Prompt/Exception/PromptExceptionType");
...
class GuessGameArgHandler {
     ...
     */
    static handle(command, resonance, userInput) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (userInput === true) {
                input = yield GuessGameArgHandler.promptForInput(command, resonance);
            }
            ...
            const opponent = yield command.fireClientHandlers(resonance, {
                userInput: input,
            }, "getOpponent");
            ...
            const confirmation = yield GuessGameArgHandler.confirmWithOpponent(command, resonance, opponent);
            ...
            const challengerResult = yield Coinflip_1.Coinflip.flipACoin();
            const opponentResult = yield Coinflip_1.Coinflip.flipACoin();
            // Add some typing suspense.
            yield resonance.typeFor(3, resonance.message.channel);
            ...
            yield resonance.typeFor(2, resonance.message.channel);
            // Now we can actually go forth with the duel!
            yield resonance.__reply("{{guesser}}! It's up to you to guess if both coin flips resulted in the **Same** result, or ended up with **Different** results.", {
                guesser,
            ...
            yield resonance.prompt(guesser, resonance.message.channel, 10, (responseResonance, prompt) => __awaiter(this, void 0, void 0, function* () {
                ...
                const guess = yield GuessGameArgHandler.resolveGuess(responseResonance.content.toLowerCase());
    ...
    static promptForInput(command, resonance) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield resonance.prompt(resonance.author, resonance.message.channel, 10, (responseResonance) => __awaiter(this, void 0, void 0, function* () {
    ...
    static resolveGuess(guess) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const synonymsOfSame = yield thesaurus.search(Guess.Same).synonyms;
            ...
            const synonymsOfDifferent = yield thesaurus.search(Guess.Different).synonyms;
            // @TODO - We can go as far as checking if ANY of the synonyms are in the text...But for now we're fine.
            if (guess === "different"
                || guess === "diff"
                || guess.split(" ")
    ...
    static confirmWithOpponent(command, resonance, opponent) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // Noinspection JSUnusedLocalSymbols
            yield resonance.prompt(opponent, resonance.message.channel, 10, (responseResonance) => __awaiter(this, void 0, void 0, function* () {
