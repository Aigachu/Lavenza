...
import { CommandConfigurations } from "../../../../../core/talents/commander/src/Command/CommandConfigurations";
import { Resonance } from "../../../../../core/lib/Lavenza/Resonance/Resonance";
import { Yoshida } from "../../../../../core/lib/Lavenza/Confidant/Yoshida";
import { AbstractObject } from "../../../../../core/lib/Lavenza/Types";
import { EightBall as EightBallTalent } from "../../../EightBall";
...
export class EightBall extends Command {
   ...
   * @inheritDoc
   */
  public async build(config: CommandConfigurations, talent: EightBallTalent): Promise<void> {
