...
const Kawakami_1 = require("../../../../../../../core/lib/Lavenza/Confidant/Kawakami");
/**
...
class Handler extends CommandClientHandler_1.CommandClientHandler {
    ...
    execute(data = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            data.percent = yield Kawakami_1.Kawakami.bold(data.percent);
            data.thing = yield Kawakami_1.Kawakami.bold(data.thing);
            // Send the result message.
            yield this.resonance.__reply("There is {{percent}} love between {{author}} and {{thing}}!", { percent: data.percent, author: this.resonance.author, thing: data.thing });
        });
    }
}
